...
# ASPECT_RATIOS = [
    ...
    # {"name": "16:9 landscape 1344x768", "width": 1344, "height": 768},
    # {"name": "21:9 landscape 1536x640", "width": 1536, "height": 640}
# ]
ASPECT_RATIOS = [
    {"name": "9:21 portrait", "width": 640, "height": 1536},
    {"name": "1:2 portrait", "width": 768, "height": 1536},
    {"name": "9:16 portrait", "width": 768, "height": 1344},
    {"name": "5:8 portrait", "width": 832, "height": 1216},
    {"name": "3:4 portrait", "width": 896, "height": 1152},
    {"name": "4:5 portrait", "width": 1024, "height": 1280},
    {"name": "5:6 portrait", "width": 1066, "height": 1280},
    {"name": "9:10 portrait", "width": 1152, "height": 1280},
    {"name": "1:1 square", "width": 1024, "height": 1024},
    {"name": "10:9 landscape", "width": 1280, "height": 1152},
    {"name": "6:5 landscape", "width": 1280, "height": 1066},
    {"name": "5:4 landscape", "width": 1280, "height": 1024},
    {"name": "4:3 landscape", "width": 1152, "height": 896},
    {"name": "3:2 landscape", "width": 1216, "height": 832},
    {"name": "16:9 wide landscape", "width": 1344, "height": 768},
    {"name": "2:1 panorama", "width": 1536, "height": 768},
    {"name": "21:9 ultra-wide", "width": 1536, "height": 640}
]
...
class FRED_AutoCropImage_Native_Ratio_v5:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "aspect_ratio": (["custom"] + ["Auto_find_resolution"] + [aspect_ratio["name"] for aspect_ratio in ASPECT_RATIOS] + ["no_crop_to_ratio"],),
    ...
    def run(self, image, Precrop_from_input_mask, aspect_ratio, custom_width, custom_height,
        ...
        if aspect_ratio == "no_crop_to_ratio":
            ...
            if aspect_ratio == "Auto_find_resolution":
                ...
                native_width, native_height = [(a["width"], a["height"]) for a in ASPECT_RATIOS
                                            if a["name"] == aspect_ratio][0]

            if native_width != original_width and native_height != original_height:
        ...
        if resize_image:
            ...
            if include_prescale_if_resize:
                ...
                # resized_mask = torch.nn.functional.interpolate(cropped_mask.unsqueeze(0), size=(native_height_wfactor, native_width_wfactor), mode="nearest").squeeze(0).clamp(0.0, 1.0)
                ...
                # resized_mask = torch.nn.functional.interpolate(cropped_mask.unsqueeze(0), size=(native_height, native_width), mode="nearest").squeeze(0).clamp(0.0, 1.0)
